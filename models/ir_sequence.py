...
class IRSequence(models.Model):
    ...
    def _auto_set_is_dte(self):
        self.is_dte = bool(self.sii_document_class_id)
    ...
    def solicitar_caf(self):
        ...
        if not wiz_caf.id_peticion:
            ...
            if wiz_caf.api_max_autor > 0 and cantidad > wiz_caf.api_max_autor:
                ...
                alert_msg = (
                    "El SII no permite solicitar más CAFs para %s, consuma los \
%s folios disponibles o verifique situación tributaria en www.sii.cl"
        ...
        if alert_msg:
            ...
            self.env["bus.bus"].sendone(
                ...
                {"title": "Alerta sobre Folios", "message": alert_msg,
                "url": "res_config", "type": "dte_notif",},
            )
            return
